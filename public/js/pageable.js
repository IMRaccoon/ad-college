...
Element.prototype.matches ||
  ...
  (function (a, b) {
    ...
    ('undefined' == typeof exports ? 'undefined' : _typeof(exports))
      ? (module.exports = b('Pageable'))
      : 'function' == typeof define && define.amd
      ? define([], b)
      : (a.Pageable = b('Pageable'));
  })(
    'undefined' == typeof global ? this.window || this.global : global,
    function () {
      'use strict';
      var a = function () {},
        b = function (a, b) {
      ...
      (f.prototype.start = function () {
        ...
        a.running ||
          ...
          (a.instance.interval = setInterval(function () {
            a.instance.config.onBeforeStart.call(
              a.instance,
              a.instance.slideIndex,
            ),
              setTimeout(function () {
                a.instance.config.infinite && a.instance._overScroll(!0),
                  a.instance.index < a.instance.pages.length - 1
                    ? a.instance.slideIndex++
                    : (a.instance.slideIndex = 0),
      ...
      var g = function (c, e) {
        ...
        return ((this.container =
          'string' == typeof c ? document.querySelector(c) : c),
        !this.container)
          ? console.error('Pageable:', 'The container could not be found.')
          : ((this.config = d(
              {
                pips: !0,
                animation: 300,
                ...
                events: { wheel: !0, mouse: !0, touch: !0, keydown: !0 },
              },
              e,
            )),
              ...
              ? void ((this.horizontal =
                ...
                this.pages.forEach(function (a, c) {
                  ...
                  (d = e
                    ...
                    : Array.isArray(f.config.anchors) && f.config.anchors.length
                    ? f.config.anchors[c].replace(/\s+/, '-').toLowerCase()
                    : a.className.replace(/\s+/, '-').toLowerCase()),
                    a.id !== d && (a.id = d),
                    f.anchors.push('#' + d),
                ...
                (this.touch =
                  ...
                  (window.DocumentTouch &&
                    _instanceof(document, DocumentTouch))),
                this.init())
              : console.error(
                  'Pageable:',
      ...
      return (
          ...
          if (!this.initialised && !this.container.pageable) {
            ...
            if (
              ...
              ['Prev', 'Next'].forEach(function (b) {
                ...
                a[c] &&
                  ('string' == typeof a[c]
                    ? (this[c] = document.querySelector(a[c]))
                    : _instanceof(a[c], Element) && (this[c] = a[c]),
            ...
            this.config.onInit.call(this, d),
              ...
              a.slideshow &&
                'function' == typeof f &&
                ((this.slider = new f(this)), this.slider.start());
          }
        }),
        (g.prototype.bind = function () {
          (this.callbacks = {
            ...
            this.navPrevEl &&
              (this.navPrevEl.addEventListener(
                'click',
                this.callbacks.prev,
                !1,
              ),
              this.navNextEl &&
                this.navNextEl.addEventListener(
                  'click',
                  this.callbacks.next,
                  !1,
                )),
        ...
        (g.prototype.unbind = function () {
          this.wrapper.removeEventListener('wheel', this.callbacks.wheel),
            ...
            this.navPrevEl &&
              this.navPrevEl.removeEventListener(
                'click',
                this.callbacks.prev,
                !1,
              ),
            this.navNextEl &&
              this.navNextEl.removeEventListener(
                'click',
                this.callbacks.next,
                !1,
              ),
        ...
        (g.prototype.next = function () {
          if (this.config.infinite) {
            ...
            if (a === this.lastIndex)
              return (
                a++, this._scrollBy(-this.data.window[this.size[this.axis]], a)
              );
          }
        ...
        (g.prototype.update = function () {
          ...
          var c = this.config.infinite
              ? this.pages.length + 2
              : this.pages.length,
            d = this.config.infinite ? this.data.window[a] : 0;
          (this.container.style[a] = c * this.data.window[a] + 'px'),
            (this.wrapper[this.scrollAxis[this.axis]] =
              this.index * this.data.window[a] + d),
        ...
        (g.prototype.off = function (a, b) {
          (this.listeners = this.listeners || {}),
            !1 == a in this.listeners ||
              this.listeners[a].splice(this.listeners[a].indexOf(b), 1);
        }),
        (g.prototype.emit = function (a) {
          if (
            ((this.listeners = this.listeners || {}), !1 != a in this.listeners)
          )
        ...
        (g.prototype._click = function (a) {
          if (a.target.closest) {
            ...
            b &&
              -1 < this.anchors.indexOf(b.hash) &&
              (a.preventDefault(), this.scrollToAnchor(b.hash));
          }
        }),
        ...
        (g.prototype._keydown = function (a) {
          if (this.config.events.keydown) {
            ...
            var b = !1;
            void 0 === a.key
              ? void 0 !== a.keyCode && (b = a.keyCode)
              : (b = a.key);
            var c = 'Arrow' + ('x' === this.axis ? 'Left' : 'Up'),
              d = 'Arrow' + ('x' === this.axis ? 'Right' : 'Down');
            b &&
              (33 === b || 37 === b || b === c || 'PageUp' === b
                ? (a.preventDefault(), this.prev())
                : 34 === b || 39 === b || b === d || 'PageDown' === b
        ...
        (g.prototype._start = function (a) {
          ...
          return (
            !(this.scrolling || this.dragging) &&
            ('touchstart' !== a.type || this.events.touch
              ? !!(
                  'mousedown' !== a.type ||
                  (this.events.mouse && 0 === a.button)
                ) &&
                !!b.target.closest(this.config.childSelector) &&
                void (this._preventDefault(a),
                (this.dragging = this.config.freeScroll),
                this.config.slideshow && this.slider.stop(),
                (this.down = { x: b.clientX, y: b.clientY }),
                (this.startIndex = this.index),
                this.config.onBeforeStart.call(this, this.index))
              : (b.target.closest('a') || this._preventDefault(a), !1))
          );
        }),
        ...
        (g.prototype._stop = function (a) {
          ...
          var f =
              Math.abs(c[this.mouseAxis[this.axis]] - this.down[this.axis]) >=
          ...
          if (
            ...
            return (
              (this.dragging = h),
              g &&
                (this.config.infinite && this._overScroll(0 > h, h),
                0 < h ? e() : d()),
          ...
          if (this.down && !this.scrolling) {
            ...
            g &&
              (this.config.infinite && this._overScroll(i), i ? d() : j && e()),
              this.startIndex === this.index
        ...
        (g.prototype._wheel = function (a) {
          if ((a.preventDefault(), this.events.wheel && !this.scrolling)) {
            var b = this.index,
              c = this.index,
              d = 0 < a.deltaY;
            this.config.infinite && this._overScroll(d),
              d
                ? this.index < this.pages.length - 1 && b++
                : 0 < this.index && b--,
              b !== c && ((this.oldIndex = c), this.scrollToIndex(b));
          }
        }),
        (g.prototype._load = function () {
          ...
          if (a) {
            ...
            if (-1 < b) {
              ...
              this.scrollPosition =
                this.data.window[this.size[this.axis]] * (b + c);
              var d = this._getData();
              (this.index = b),
                (this.slideIndex = b),
        ...
        (g.prototype._getData = function () {
          var a = this.config.infinite
              ? this.scrollPosition - this.data.window[this.size[this.axis]]
              : this.scrollPosition,
            b = this.config.infinite
              ? this.scrollSize - 2 * this.data.window[this.size[this.axis]]
              : this.scrollSize;
          return {
            index: this.index,
            percent: 100 * (a / b),
            ...
            function () {
              ...
              c.config.onStart.call(c, c.pages[c.index].id),
                ...
                (c.frame = requestAnimationFrame(function f() {
                  ...
                  if (h > c.config.animation) {
                    cancelAnimationFrame(c.frame),
                      ...
                      c.config.infinite &&
                        (b === c.pageCount
                          ? (c.index = 0)
                          : -1 === b && (c.index = c.lastIndex));
                    var i = c._getData();
                    return (
                      (window.location.hash = c.pages[c.index].id),
                  ...
                  (c.container.style.transform = c.horizontal
        ...
        (g.prototype._getScrollOffset = function () {
          return { x: this.wrapper.scrollLeft, y: this.wrapper.scrollTop };
        }),
        ...
        (g.prototype._limitDrag = function (a) {
          ...
          return (
            !this.config.infinite &&
              ((0 === this.index && 0 < b) ||
                (this.index === this.pages.length - 1 && 0 > b)) &&
              (b /= 10),
            b
          );
        }),
        (g.prototype._setNavs = function () {
          this.navPrevEl &&
            ...
            this.navNextEl &&
              (this.config.infinite || this.index < this.pages.length - 1
        ...
        (g.prototype._setPips = function (a) {
          this.config.pips &&
            ...
            this.pips.forEach(function (b, c) {
              c == a
                ? b.firstElementChild.classList.add('active')
